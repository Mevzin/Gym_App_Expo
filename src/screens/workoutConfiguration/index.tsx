    ...
    return (
        <View className="flex-1 bg-primary">
            <View className="flex-row items-center justify-between p-4 pt-5 bg-primary">
                ...
                <Text className="text-white text-lg font-bold font-roboto">Configurar Treino</Text>
                <TouchableOpacity
            ...
            <ScrollView className="flex-1">
                ...
                <View className="px-4 mb-4">
                    ...
                    <View className="flex-row space-x-2 gap-2">
                        ...
                        >
                            <Text className="text-white font-medium text-sm font-roboto">Push/Pull/Legs</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            className="bg-red-600 px-4 py-2 rounded-lg"
                            onPress={() => applyTemplate('upper-lower')}
                        >
                            <Text className="text-white font-medium text-sm font-roboto">Upper/Lower</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            className="bg-red-600 px-4 py-2 rounded-lg"
                            onPress={() => applyTemplate('full-body')}
                        >
                            <Text className="text-white font-medium text-sm font-roboto">Full Body</Text>
                        </TouchableOpacity>
                    </View>
                </View>
